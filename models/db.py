...
# auth.settings.extra_fields['auth_user']= [
#     Field('telefone', writable=False, readable=False ),
#     format = '%(first_name)s %(last_name)s']
# auth = Auth(db, format = '%(first_name)s %(last_name)s')
...
db.define_table('usuario_empresa',
                ...
                Field('tipo', 'string', label='Tipo', default='Administrador', requires=IS_IN_SET(['Administrador', 'Analista', 'Programador'])),
